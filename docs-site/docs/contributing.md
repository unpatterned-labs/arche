...
- labelled record pairs with clear licences and provenance
- documented false merges and missed matches
- equivalence, identifier, and vocabulary data with sources and scope
- reproducible benchmark scripts and result files
- corrections to documentation claims that have drifted from the code
