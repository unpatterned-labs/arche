...
| 3 | **Entity reference resolution** | Deciding co-reference | Shipped pairwise (gated, veto'd, [signable](verifiability.md)) and at scale (`crosswalk`); transitive clustering is gated post-beta work |
