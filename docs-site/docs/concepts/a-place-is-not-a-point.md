...
*Related: [the representation engine](representation-engine.md) · [the five ER activities](er-activities.md) · [place resolution at scale (NG + UK)](../tutorials/place_resolution_at_scale.md) · [verifiability: the signature on the decision](verifiability.md).*
