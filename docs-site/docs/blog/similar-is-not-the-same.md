...
*Related: [a representation engine, not an inference engine](../concepts/representation-engine.md) · [a place is not a point](../concepts/a-place-is-not-a-point.md) · [the place benchmark](../concepts/place-benchmark.md) · [how arche works](../concepts/how-it-works.md).*
