...
**Next:** [read crosswalk output field-by-field](../how-to/read-crosswalk-output.md) · [places at scale](place_resolution_at_scale.md) · the resolution-attestation notebook for the full signing story.
