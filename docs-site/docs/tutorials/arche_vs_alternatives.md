...
- **[Entity resolution tools compared](../comparison/entity-resolution.md)** — the matching/linkage side of this page: arche vs Splink, dedupe, Senzing, recordlinkage, Zingg.
- **[Live demo: demo.unpatterned.org](https://demo.unpatterned.org)** — the 30-second tour: paste text, see detections + tier + citation, copy a JWS receipt.
