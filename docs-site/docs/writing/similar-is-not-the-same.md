...
*Related: [Evidence, gates and distinctiveness](../how-it-works/evidence.md) · [Backends: arche, Splink, auto](../how-it-works/backends.md) · [Benchmarks](../reference/benchmarks.md).*
