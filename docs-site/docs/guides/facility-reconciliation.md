...
The current Kano, Ondo, and Edo baseline records candidate and review counts,
not accuracy claims. Reviewers should complete the outcome, reviewer, UTC time,
and reason for each candidate without changing its original evidence or
`decision_id`.
...
Confirm administration and distance, compare the distinctive part of the name,
and check stable facility codes and source dates where available. Escalate a
