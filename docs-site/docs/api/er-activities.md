...
| 3 | **Entity reference resolution** | Deciding co-reference | Shipped pairwise (gated, veto'd, [signable](../how-to/attest.md)) and at scale (`reconcile`); transitive clustering is gated post-beta work |
