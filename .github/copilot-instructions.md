...
## Project defaults
- **Project**: `arche` — the open-source identity workflow framework by Unpatterned Labs. The repo is a `uv` workspace; the published Python package is `arche-core` under `packages/arche-core/`.
